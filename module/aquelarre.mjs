...
Hooks.once('init', async function() {
  ...
  Actors.registerSheet("aquelarre", AquelarreActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("aquelarre", AquelarreItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.aquelarre.rollItemMacro("${item.name}");`;
